...
CREATE TABLE IF NOT EXISTS "public"."conversation_participants" (
    ...
    CONSTRAINT "conversation_participants_role_check" CHECK ((("role")::"text" = ANY ((ARRAY['admin'::character varying, 'participant'::character varying])::"text"[]))),
...
CREATE TABLE IF NOT EXISTS "public"."conversations" (
    ...
    "scope_id" "uuid",
    CONSTRAINT "conversations_conversation_type_check" CHECK ((("conversation_type")::"text" = ANY ((ARRAY['direct'::character varying, 'team_chat'::character varying, 'captains_chat'::character varying, 'announcements'::character varying])::"text"[]))),
    CONSTRAINT "conversations_scope_type_check" CHECK ((("scope_type")::"text" = ANY ((ARRAY['team'::character varying, 'season'::character varying, 'organization'::character varying, 'none'::character varying])::"text"[]))),
...
CREATE TABLE IF NOT EXISTS "public"."league_operators" (
    ...
    CONSTRAINT "league_operators_email_visibility_check" CHECK ((("email_visibility")::"text" = ANY ((ARRAY['in_app_only'::character varying, 'my_organization'::character varying, 'my_team_captains'::character varying, 'my_teams'::character varying, 'anyone'::character varying])::"text"[]))),
    ...
    CONSTRAINT "league_operators_phone_visibility_check" CHECK ((("phone_visibility")::"text" = ANY ((ARRAY['in_app_only'::character varying, 'my_organization'::character varying, 'my_team_captains'::character varying, 'my_teams'::character varying, 'anyone'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."leagues" (
    ...
    CONSTRAINT "leagues_day_of_week_check" CHECK ((("day_of_week")::"text" = ANY ((ARRAY['monday'::character varying, 'tuesday'::character varying, 'wednesday'::character varying, 'thursday'::character varying, 'friday'::character varying, 'saturday'::character varying, 'sunday'::character varying])::"text"[]))),
    CONSTRAINT "leagues_game_type_check" CHECK ((("game_type")::"text" = ANY ((ARRAY['eight_ball'::character varying, 'nine_ball'::character varying, 'ten_ball'::character varying])::"text"[]))),
    CONSTRAINT "leagues_handicap_level_check" CHECK ((("handicap_level")::"text" = ANY ((ARRAY['standard'::character varying, 'reduced'::character varying, 'none'::character varying])::"text"[]))),
    CONSTRAINT "leagues_handicap_variant_check" CHECK (("handicap_variant" = ANY (ARRAY['standard'::"text", 'reduced'::"text", 'none'::"text"]))),
    CONSTRAINT "leagues_status_check" CHECK ((("status")::"text" = ANY ((ARRAY['active'::character varying, 'completed'::character varying, 'abandoned'::character varying])::"text"[]))),
    CONSTRAINT "leagues_team_format_check" CHECK ((("team_format")::"text" = ANY ((ARRAY['5_man'::character varying, '8_man'::character varying])::"text"[]))),
...
COMMENT ON COLUMN "public"."match_games"."confirmed_by_home" IS 'True when home team has confirmed this game result. Both teams must confirm for game to be official.';



COMMENT ON COLUMN "public"."match_games"."confirmed_by_away" IS 'True when away team has confirmed this game result. Both teams must confirm for game to be official.';
...
CREATE TABLE IF NOT EXISTS "public"."match_lineups" (
    ...
    "player1_id" "uuid",
    "player1_handicap" numeric(3,1) NOT NULL,
    "player2_id" "uuid",
    "player2_handicap" numeric(3,1) NOT NULL,
    "player3_id" "uuid",
    "player3_handicap" numeric(3,1) NOT NULL,
    "locked" boolean DEFAULT false NOT NULL,
    "locked_at" timestamp with time zone,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "team_handicap" integer DEFAULT 0 NOT NULL,
    CONSTRAINT "match_lineups_check" CHECK ((((
CASE
    WHEN ("player1_id" IS NULL) THEN 1
    ELSE 0
END +
CASE
    WHEN ("player2_id" IS NULL) THEN 1
    ELSE 0
END) +
CASE
    WHEN ("player3_id" IS NULL) THEN 1
    ELSE 0
END) <= 1))
);
...
COMMENT ON COLUMN "public"."match_lineups"."team_handicap" IS 'Team handicap bonus (based on season standings). Only applies to home team but stored in both lineups for consistency.';
...
CREATE TABLE IF NOT EXISTS "public"."matches" (
    ...
    "home_points_earned" integer DEFAULT 0 NOT NULL,
    "away_points_earned" integer DEFAULT 0 NOT NULL,
    "winner_team_id" "uuid",
    "match_result" "text",
    ...
    CONSTRAINT "matches_status_check" CHECK (("status" = ANY (ARRAY['scheduled'::"text", 'in_progress'::"text", 'results_ready'::"text", 'completed'::"text", 'finalized'::"text", 'forfeited'::"text", 'postponed'::"text"])))
);
...
COMMENT ON COLUMN "public"."matches"."home_points_earned" IS 'Points earned by home team (games won beyond games_to_win threshold)';



COMMENT ON COLUMN "public"."matches"."away_points_earned" IS 'Points earned by away team (games won beyond games_to_win threshold)';
...
CREATE TABLE IF NOT EXISTS "public"."season_weeks" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "season_weeks_week_type_check" CHECK ((("week_type")::"text" = ANY ((ARRAY['regular'::character varying, 'blackout'::character varying, 'playoffs'::character varying, 'season_end_break'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."team_players" (
    ...
    CONSTRAINT "team_players_status_check" CHECK ((("status")::"text" = ANY ((ARRAY['active'::character varying, 'inactive'::character varying, 'dropped'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."teams" (
    ...
    CONSTRAINT "teams_status_check" CHECK ((("status")::"text" = ANY ((ARRAY['active'::character varying, 'withdrawn'::character varying, 'forfeited'::character varying])::"text"[]))),
...
ALTER TABLE ONLY "public"."match_games"
    ADD CONSTRAINT "match_games_away_player_id_fkey" FOREIGN KEY ("away_player_id") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."match_games"
    ADD CONSTRAINT "match_games_home_player_id_fkey" FOREIGN KEY ("home_player_id") REFERENCES "public"."members"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."match_games"
    ADD CONSTRAINT "match_games_winner_player_id_fkey" FOREIGN KEY ("winner_player_id") REFERENCES "public"."members"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."match_lineups"
    ADD CONSTRAINT "match_lineups_player1_id_fkey" FOREIGN KEY ("player1_id") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."match_lineups"
    ADD CONSTRAINT "match_lineups_player2_id_fkey" FOREIGN KEY ("player2_id") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."match_lineups"
    ADD CONSTRAINT "match_lineups_player3_id_fkey" FOREIGN KEY ("player3_id") REFERENCES "public"."members"("id") ON DELETE SET NULL;
...
CREATE POLICY "Team members can update unlocked lineup" ON "public"."match_lineups" FOR UPDATE USING (((EXISTS ( SELECT 1
   FROM ("public"."team_players" "tp"
     JOIN "public"."members" "m" ON (("m"."id" = "tp"."member_id")))
  WHERE (("tp"."team_id" = "match_lineups"."team_id") AND ("m"."user_id" = "auth"."uid"())))) AND ("locked" = false))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."team_players" "tp"
     JOIN "public"."members" "m" ON (("m"."id" = "tp"."member_id")))
  WHERE (("tp"."team_id" = "match_lineups"."team_id") AND ("m"."user_id" = "auth"."uid"())))));
