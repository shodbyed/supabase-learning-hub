...
CREATE INDEX "idx_user_reports_assigned_operator" ON "public"."user_reports" USING "btree" ("assigned_organization_id");
...
ALTER TABLE ONLY "public"."user_reports"
    ADD CONSTRAINT "user_reports_assigned_organization_id_fkey" FOREIGN KEY ("assigned_organization_id") REFERENCES "public"."organizations"("id") ON DELETE SET NULL;
