--
-- Supabase Learning Hub - Full Database Dump
-- Date: 2025-11-24
--
-- This is a complete database dump including schema and data.
-- Use this dump to restore the entire database structure and all data.
--
-- To restore:
--   psql -U postgres -h localhost -p 54322 -d postgres -f database/supabase_dump_2025-11-24.sql
--
...
CREATE TABLE IF NOT EXISTS "public"."preferences" (
    ...
    CONSTRAINT "preferences_game_history_limit_check" CHECK ((("game_history_limit" > 0) AND ("game_history_limit" <= 500))),
...
COMMENT ON COLUMN "public"."preferences"."entity_id" IS 'ID of the entity: operator_id for organization, league_id for league';
...
CREATE OR REPLACE VIEW "public"."resolved_league_preferences" AS
 SELECT "l"."id" AS "league_id",
   ...
   FROM (("public"."leagues" "l"
     LEFT JOIN "public"."preferences" "org_prefs" ON ((("org_prefs"."entity_type" = 'organization'::"text") AND ("org_prefs"."entity_id" = "l"."operator_id"))))
...
CREATE OR REPLACE TRIGGER "trigger_create_org_preferences" AFTER INSERT ON "public"."league_operators" FOR EACH ROW EXECUTE FUNCTION "public"."create_default_org_preferences"();
