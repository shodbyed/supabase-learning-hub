-- =====================================================
-- FIX: Update Operator Stats RPC Function
-- =====================================================
-- This fixes the league count filter to match the original query
-- The original didn't filter by is_active, so we remove that filter
-- =====================================================
