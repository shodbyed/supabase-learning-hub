...
CREATE OR REPLACE FUNCTION "public"."create_default_league_preferences"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_default_league_preferences"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_default_org_preferences"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  INSERT INTO preferences (entity_type, entity_id)
...
ALTER FUNCTION "public"."create_default_org_preferences"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_owner_staff"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_owner_staff"() OWNER TO "postgres";


COMMENT ON FUNCTION "public"."create_owner_staff"() IS 'Automatically creates owner staff record when organization is created';
...
CREATE TABLE IF NOT EXISTS "public"."handicap_chart_3vs3" (
...
ALTER TABLE "public"."handicap_chart_3vs3" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."match_lineups"."player4_handicap" IS 'Fourth player handicap at time of lineup lock (used for 5v5 matches)';
...
COMMENT ON COLUMN "public"."match_lineups"."player5_handicap" IS 'Fifth player handicap at time of lineup lock (used for 5v5 matches)';
...
COMMENT ON TABLE "public"."organization_staff" IS 'Many-to-many relationship between members and organizations with position-based access';



COMMENT ON COLUMN "public"."organization_staff"."position" IS 'owner (creator, can add/remove staff), admin (operations), league_rep (future use)';



COMMENT ON COLUMN "public"."organization_staff"."added_by" IS 'Member who added this person to the organization';
...
COMMENT ON TABLE "public"."organizations" IS 'Organization details for league operators. Supports multiple staff managing same organization.';



COMMENT ON COLUMN "public"."organizations"."organization_email" IS 'Contact email for the organization';



COMMENT ON COLUMN "public"."organizations"."organization_email_visibility" IS 'Who can see the organization email: public, my_organization, or my_teams';



COMMENT ON COLUMN "public"."organizations"."organization_phone" IS 'Contact phone number for the organization';



COMMENT ON COLUMN "public"."organizations"."organization_phone_visibility" IS 'Who can see the organization phone: public, my_organization, or my_teams';



COMMENT ON COLUMN "public"."organizations"."profanity_filter_enabled" IS 'Whether to enforce profanity validation for team names and organization content';



COMMENT ON COLUMN "public"."organizations"."created_by" IS 'Member who originally created this organization (becomes owner in organization_staff)';
...
COMMENT ON TABLE "public"."preferences" IS 'Stores both organization-level defaults and league-level overrides. NULL values cascade to next level (league → organization → system default).';



COMMENT ON COLUMN "public"."preferences"."entity_type" IS 'Type of entity: organization (defaults for all leagues) or league (overrides for specific league)';



COMMENT ON COLUMN "public"."preferences"."entity_id" IS 'ID of the entity: organization_id for organization, league_id for league';



COMMENT ON COLUMN "public"."preferences"."handicap_variant" IS 'Player handicap calculation method. NULL = use next level default';



COMMENT ON COLUMN "public"."preferences"."team_handicap_variant" IS 'Team bonus calculation method. NULL = use next level default';



COMMENT ON COLUMN "public"."preferences"."game_history_limit" IS 'Number of recent games for handicap calculation. NULL = use next level default (system default: 200)';



COMMENT ON COLUMN "public"."preferences"."team_format" IS 'Default team format for new leagues. NULL = use next level default (system default: 5_man)';



COMMENT ON COLUMN "public"."preferences"."golden_break_counts_as_win" IS 'Whether golden breaks count as wins. NULL = use next level default (system default: true)';
...
CREATE OR REPLACE VIEW "public"."resolved_league_preferences" AS
 SELECT "l"."id" AS "league_id",
   ...
   FROM (("public"."leagues" "l"
     ...
     LEFT JOIN "public"."preferences" "league_prefs" ON ((("league_prefs"."entity_type" = 'league'::"text") AND ("league_prefs"."entity_id" = "l"."id"))));


ALTER VIEW "public"."resolved_league_preferences" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."venues"."organization_id" IS 'Operator who first created this venue. NULL if operator deleted. Venues persist independently.';
...
ALTER TABLE ONLY "public"."handicap_chart_3vs3"
    ADD CONSTRAINT "handicap_chart_3vs3_pkey" PRIMARY KEY ("hcp_diff");
...
ALTER TABLE ONLY "public"."organization_staff"
    ADD CONSTRAINT "organization_staff_organization_id_member_id_key" UNIQUE ("organization_id", "member_id");
...
ALTER TABLE ONLY "public"."preferences"
    ADD CONSTRAINT "preferences_entity_type_entity_id_key" UNIQUE ("entity_type", "entity_id");
...
CREATE INDEX "idx_operator_blackout_preferences_organization_id" ON "public"."operator_blackout_preferences" USING "btree" ("organization_id");
...
CREATE INDEX "idx_org_staff_member" ON "public"."organization_staff" USING "btree" ("member_id");



CREATE INDEX "idx_org_staff_org" ON "public"."organization_staff" USING "btree" ("organization_id");



CREATE INDEX "idx_org_staff_position" ON "public"."organization_staff" USING "btree" ("position");
...
CREATE INDEX "idx_preferences_entity" ON "public"."preferences" USING "btree" ("entity_type", "entity_id");



CREATE INDEX "idx_preferences_league" ON "public"."preferences" USING "btree" ("entity_type", "entity_id") WHERE ("entity_type" = 'league'::"text");



CREATE INDEX "idx_preferences_organization" ON "public"."preferences" USING "btree" ("entity_type", "entity_id") WHERE ("entity_type" = 'organization'::"text");
...
CREATE INDEX "idx_venues_organization_id" ON "public"."venues" USING "btree" ("organization_id");
...
CREATE OR REPLACE TRIGGER "create_owner_staff_trigger" AFTER INSERT ON "public"."organizations" FOR EACH ROW EXECUTE FUNCTION "public"."create_owner_staff"();
...
CREATE OR REPLACE TRIGGER "trigger_create_league_preferences" AFTER INSERT ON "public"."leagues" FOR EACH ROW EXECUTE FUNCTION "public"."create_default_league_preferences"();



CREATE OR REPLACE TRIGGER "trigger_create_org_preferences" AFTER INSERT ON "public"."organizations" FOR EACH ROW EXECUTE FUNCTION "public"."create_default_org_preferences"();
...
ALTER TABLE ONLY "public"."operator_blackout_preferences"
    ADD CONSTRAINT "operator_blackout_preferences_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."organization_staff"
    ADD CONSTRAINT "organization_staff_added_by_fkey" FOREIGN KEY ("added_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."organization_staff"
    ADD CONSTRAINT "organization_staff_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."members"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."organizations"
    ADD CONSTRAINT "organizations_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."members"("id") ON DELETE RESTRICT;
...
CREATE POLICY "League operators can delete their league matches" ON "public"."matches" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM ((("public"."seasons" "s"
     ...
     JOIN "public"."league_operators" "lo" ON (("l"."organization_id" = "lo"."id")))
...
CREATE POLICY "Operators can add players to own league teams" ON "public"."team_players" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM ((("public"."teams"
     ...
     JOIN "public"."league_operators" ON (("leagues"."organization_id" = "league_operators"."id")))
...
CREATE POLICY "Operators can create own leagues" ON "public"."leagues" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
  ...
  WHERE (("league_operators"."id" = "leagues"."organization_id") AND ("members"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Operators can create venues" ON "public"."venues" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."league_operators"
     JOIN "public"."members" ON (("league_operators"."member_id" = "members"."id")))
  WHERE (("league_operators"."id" = "venues"."organization_id") AND ("members"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Operators can delete their own preferences" ON "public"."operator_blackout_preferences" FOR DELETE USING (("organization_id" IN ( SELECT "league_operators"."id"
   FROM "public"."league_operators"
...
CREATE POLICY "Operators can insert their own preferences" ON "public"."operator_blackout_preferences" FOR INSERT WITH CHECK (("organization_id" IN ( SELECT "league_operators"."id"
   FROM "public"."league_operators"
  WHERE ("league_operators"."member_id" IN ( SELECT "members"."id"
           FROM "public"."members"
          WHERE ("members"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "Operators can update league reports" ON "public"."user_reports" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM (((("public"."league_operators" "lo"
     JOIN "public"."leagues" "l" ON (("l"."organization_id" = "lo"."id")))
...
CREATE POLICY "Operators can update their own preferences" ON "public"."operator_blackout_preferences" FOR UPDATE USING (("organization_id" IN ( SELECT "league_operators"."id"
   FROM "public"."league_operators"
  WHERE ("league_operators"."member_id" IN ( SELECT "members"."id"
           FROM "public"."members"
          WHERE ("members"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "Operators can view their own preferences" ON "public"."operator_blackout_preferences" FOR SELECT USING (("organization_id" IN ( SELECT "league_operators"."id"
   FROM "public"."league_operators"
  WHERE ("league_operators"."member_id" IN ( SELECT "members"."id"
           FROM "public"."members"
          WHERE ("members"."user_id" = "auth"."uid"()))))));
...
ALTER TABLE "public"."league_operators" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."create_default_league_preferences"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_default_league_preferences"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_default_league_preferences"() TO "service_role";



GRANT ALL ON FUNCTION "public"."create_default_org_preferences"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_default_org_preferences"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_default_org_preferences"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_owner_staff"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_owner_staff"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_owner_staff"() TO "service_role";
...
GRANT ALL ON TABLE "public"."handicap_chart_3vs3" TO "anon";
GRANT ALL ON TABLE "public"."handicap_chart_3vs3" TO "authenticated";
GRANT ALL ON TABLE "public"."handicap_chart_3vs3" TO "service_role";
...
GRANT ALL ON TABLE "public"."resolved_league_preferences" TO "anon";
GRANT ALL ON TABLE "public"."resolved_league_preferences" TO "authenticated";
GRANT ALL ON TABLE "public"."resolved_league_preferences" TO "service_role";
