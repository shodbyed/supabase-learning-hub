...
CREATE TABLE IF NOT EXISTS "public"."match_lineups" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "home_team_modifier" integer DEFAULT 0 NOT NULL,
    "player4_id" "uuid",
    "player4_handicap" numeric(3,1),
    "player5_id" "uuid",
    "player5_handicap" numeric(3,1)
);
...
ALTER TABLE ONLY "public"."match_lineups"
    ADD CONSTRAINT "match_lineups_player4_id_fkey" FOREIGN KEY ("player4_id") REFERENCES "public"."members"("id");



ALTER TABLE ONLY "public"."match_lineups"
    ADD CONSTRAINT "match_lineups_player5_id_fkey" FOREIGN KEY ("player5_id") REFERENCES "public"."members"("id");
...
CREATE POLICY "Players can update match thresholds for their matches" ON "public"."matches" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM ("public"."team_players" "tp"
     JOIN "public"."members" "m" ON (("m"."id" = "tp"."member_id")))
  WHERE ((("tp"."team_id" = "matches"."home_team_id") OR ("tp"."team_id" = "matches"."away_team_id")) AND ("m"."user_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."team_players" "tp"
     JOIN "public"."members" "m" ON (("m"."id" = "tp"."member_id")))
  WHERE ((("tp"."team_id" = "matches"."home_team_id") OR ("tp"."team_id" = "matches"."away_team_id")) AND ("m"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Team members can lock or unlock lineup" ON "public"."match_lineups" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM ("public"."team_players" "tp"
     JOIN "public"."members" "m" ON (("m"."id" = "tp"."member_id")))
...
CREATE POLICY "Team members can update unlocked lineup data" ON "public"."match_lineups" FOR UPDATE USING (((EXISTS ( SELECT 1
   FROM ("public"."team_players" "tp"
     JOIN "public"."members" "m" ON (("m"."id" = "tp"."member_id")))
